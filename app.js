...
// ---------- 模型持久缓存状态 ----------
const MODEL_CACHE = 'seichi-models-v7'; // v7: ISNet 换 int8 权重版（w8，84→42MB），旧 fp16 缓存作废
...
const MODEL_DOWNLOAD_PROBES = [
  ['GitHub · 人物检测模型', `${MODEL_BASE}/models/person-detect.onnx`],
  ['GitHub · 抠图模型分块', `${MODEL_BASE}/models/isnet-anime-w8.onnx.part00`],
